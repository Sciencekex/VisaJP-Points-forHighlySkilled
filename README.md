...
> **关键发现**：日本绝大部分 **国立大学**（含地方国立大学）都在⑰加分名单上。它们不一定在 QS 前 300，但由于 SGU 或 Innovative Asia 的认定，同样享有⑰ +10 分资格。详见仓库内 `WeChat_pic_2026-06-11_205334_253.jpg` QS排名截图与 PDF 名单对比。
...
🔑 **核心逻辑**：日本"国立大学"这块金字招牌，基本都在⑰指定大学名单上。即便是 QS 排名千名开外的地方国立大学，也通过 SGU 或 Innovative Asia 的管道进入了加分名单——这意味着 **⑭ 和 ⑰ 可同时获得，累加 20 分**。

#### 推荐路径：日本地方国立大学院

| 优势 | 说明 |
|------|------|
| **⑭ + ⑰ 双加** | 地方国立大学同时满足⑭和⑰，**20 分一次到手** |
| **⑮ 日语能力联动** | 在日学习期间考取 N1（+15分）或 N2（+10分） |
| **学历+大学双红利** | 修士（+20）+ ⑭（+10）+ ⑰（+10）+ N1（+15）= 已有 **55分** |
| **费用可控** | 地方国立大学学费远低于东京圈私立名校 |
| **就职衔接** | 毕业后就地进入日本企业，年收和职历自然达标 |
